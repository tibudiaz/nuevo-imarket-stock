...
import { Home, Package, ShoppingCart, Users, Wrench, ChevronDown, LayoutDashboard, AlertTriangle, Calculator, ClipboardList, Truck, Speaker } from "lucide-react"
...
export default function MobileMenu({ userRole }: MobileMenuProps) {
  ...
  const mainRoutes = [
    ...
    { href: "/dashboard/jbl", label: "JBL", icon: Speaker, active: pathname === "/dashboard/jbl", role: ["admin", "moderator"] },
